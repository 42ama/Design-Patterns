...
{
    /// <summary>
    /// Профессиональный и дорогой бармен, использующий дорогие ингредиенты в коктейлях.
    /// </summary>
    public class ProfessionalBartender : AbstractBartender
    {
        /// <summary>
        ...
        {
            Cocktail.AppendLine("Коктейль хорошо охлажден льдом, что делает его вкуснее.");
        }
